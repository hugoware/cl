...
// lesson controller
var codeObjectsComplexLesson = function () {

	// setup the lesson
	function codeObjectsComplexLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, codeObjectsComplexLesson);
	...
	_createClass(codeObjectsComplexLesson, [{
		key: 'activateSlide',
	...
	return codeObjectsComplexLesson;
}();
...
window.registerLesson('code_objects_complex', codeObjectsComplexLesson);
