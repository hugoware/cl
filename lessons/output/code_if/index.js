...
(0, _waitForValidation2.default)(module.exports, {
	...
	validation: function validation(test, code) {
		...
		test.lines(2);
		(0, _validation.validate_variables)(test, { same: true });
		test.lines(2);
		(0, _validation.validate_if)(test);
		test.lines(2);
		(0, _validation.validate_else_if)(test);

		test._n;
		test.clearBounds();
		test.lines(2);
		(0, _validation.validate_else)(test);
		test.lines(2).eof();
	},
...
},{"./controllers/waitForValidation":4,"./lib":12,"./utils":15,"./validation":16}],6:[function(require,module,exports){
'use strict';
...
(0, _waitForValidation2.default)(module.exports, {
	...
	validation: function validation(test, code) {
		...
		test.lines(2);
		(0, _validation.validate_variables)(test, { flip: true });
		test.lines(2);
		(0, _validation.validate_if)(test);
		test.lines(2);
		(0, _validation.validate_else_if)(test);
	...
	onEnter: function onEnter() {
		...
		var index = content.indexOf('else {');
		content = content.replace(/else \{/g, '\n\nelse {');
		this.file.content({ path: '/main.js', content: content, replaceRestore: true });
...
},{"./controllers/waitForValidation":4,"./lib":12,"./utils":15,"./validation":16}],7:[function(require,module,exports){
'use strict';
...
},{"./controllers/waitForValidation":4,"./lib":12,"./utils":15,"./validation":16}],8:[function(require,module,exports){
'use strict';
...
},{"./controllers/waitForValidation":4,"./lib":12,"./utils":15,"./validation":16}],9:[function(require,module,exports){
'use strict';
...
},{"./controllers/waitForValidation":4,"./lib":12,"./utils":15,"./validation":16}],10:[function(require,module,exports){
'use strict';
...
},{"./controllers/waitForValidation":4,"./lib":12,"./utils":15,"./validation":16}],11:[function(require,module,exports){
'use strict';
...
var _ifElseIfStatement = require('./ifElseIfStatement');

var ifElseIfStatement = _interopRequireWildcard(_ifElseIfStatement);

var _ifElseIfStatementPrepare = require('./ifElseIfStatementPrepare');

var ifElseIfStatementPrepare = _interopRequireWildcard(_ifElseIfStatementPrepare);

var _ifElseStatement = require('./ifElseStatement');

var ifElseStatement = _interopRequireWildcard(_ifElseStatement);

var _ifElseStatementFlip = require('./ifElseStatementFlip');

var ifElseStatementFlip = _interopRequireWildcard(_ifElseStatementFlip);

var _ifStatement = require('./ifStatement');

var ifStatement = _interopRequireWildcard(_ifStatement);

var _ifStatementFlip = require('./ifStatementFlip');

var ifStatementFlip = _interopRequireWildcard(_ifStatementFlip);

var _runCode = require('./runCode');

var runCode = _interopRequireWildcard(_runCode);

var _usingAsk = require('./usingAsk');

var usingAsk = _interopRequireWildcard(_usingAsk);
...
// lesson controller
var codeIfLesson = function () {

  // setup the lesson
  function codeIfLesson(project, lesson, api) {
    var _this = this;

    _classCallCheck(this, codeIfLesson);
    ...
    // core lesson data
    this.data = {
      "name": "Using Logical Comparisons",
      "type": "code",
      ...
      "lesson": [{
        ...
        "content": "try to switch the variables so there's enough chairs and run it again\n"
      }, {
        "content": "this time there wasn't a message because there was enough\n"
      }, {
        "mode": "overlay",
        "content": "we need to have a message when the condition is false\n\ncan't just put it afterwards or it would run every time\n"
      }, {
        "content": "fortunately, it's pretty easy to do using the `else`\n\n[snippet else_example]\n"
      }, {
        "content": "when the conditions is true, the first block is run\n\n[snippet else_example]\n"
      }, {
        "content": "when the condition is false, the second block is run\n\n[snippet else_example]\n"
      }, {
        "mode": "popup",
        "content": "let's try and edit the code to inclde the if statement\n"
      }, {
        "controller": "ifElseStatement",
        "content": "follow instructions\n"
      }, {
        "controller": "ifElseStatementFlip",
        "content": "like with before, try the inverse now\n"
      }, {
        "mode": "overlay",
        "content": "theres another one you can use called if else\n"
      }, {
        "content": "allows you to do a condition after another condition\n\n[snippet else_if_example]\n"
      }, {
        "content": "useful for mulitple scenarios\n"
      }, {
        "content": "as before, the expression is evaluated\n"
      }, {
        "content": "then tested against the first block\n"
      }, {
        "content": "if that doesn't pass, the next expression is tested\n"
      }, {
        "content": "if it passes, that block is executed\n"
      }, {
        "mode": "popup",
        "content": "lets try again with an `else if` statement\n"
      }, {
        "controller": "ifElseIfStatementPrepare",
        "content": "follow along with the instructions\n"
      }, {
        "controller": "ifElseIfStatement",
        "content": "change the value to exactly match the original value\n"
      }, {
        "mode": "overlay",
        "content": "conditions match the contents of variables\n"
      }, {
        "content": "computer programs take input to make choices\n"
      }, {
        ...
        "choices": ["`if`, `else`, and `else if`", "`when`, `otherwise`, and `except`", "`sometimes`, `always`, and `never`", "`before`, `after`, and `later`"],
        "explain": "if/else/elseif\n"
      }, {
        "title": "What is a \"block\" of code?",
        "choices": ["Between curly braces", "Code that will not have errors", "Special numbers in JavaScript that", "Alt thing"],
        "explain": "if/else/elseif\n"
      }, {
        "title": "What message would be printed at the end of this",
        "content": "[snippet question_1 size:small]\n",
        "choices": ["The message `\"first\"` is printed in the output", "The message `\"second\"` is printed in the output", "Nothing, no messages will be displayed", "Nothing, this code has errors and will not run"],
        "explain": "if/else/elseif\n  \n"
      }, {
        "title": "What message would be printed at the end of this",
        "content": "[snippet question_2 size:small]\n",
        "choices": ["The message `\"not match\"` is printed in the output", "The message `\"is apple\"` is printed in the output", "The message `\"is banana\"` is printed in the output", "The message `\"is orange\"` is printed in the output"],
        "explain": "if/else/elseif\n"
      }, {
        "mode": "popup",
      ...
      "snippets": {
        "else_example": {
          "content": "if (totalStudents > totalBooks) {\n  console.log('not enough books')\n}\nelse {\n  console.log('we have extra books')\n}",
          "type": "javascript"
        },
        "else_if_example": {
          "content": "if (totalStudents > totalBooks) {\n  console.log('not enough books')\n}\nelse if (totalStudents === totalBooks) {\n  console.log('exactly enough books');\n}\nelse {\n  console.log('we have extra books')\n}",
          "type": "javascript"
        },
        "first_example": {
          "content": "let totalStudents = 10;\nlet totalBooks = 5;\n\nif (totalStudents > totalBooks) {\n  console.log('not enough books');\n}",
          "type": "javascript"
        },
        "if_example": {
    ...
    var refs = {
      ifElseIfStatement: ifElseIfStatement, ifElseIfStatementPrepare: ifElseIfStatementPrepare, ifElseStatement: ifElseStatement, ifElseStatementFlip: ifElseStatementFlip, ifStatement: ifStatement, ifStatementFlip: ifStatementFlip, runCode: runCode, usingAsk: usingAsk, validation: validation
    };
...
window.registerLesson('code_if', codeIfLesson);

},{"./controllers/waitForFile":1,"./controllers/waitForObjectivesList":2,"./controllers/waitForTab":3,"./ifElseIfStatement":5,"./ifElseIfStatementPrepare":6,"./ifElseStatement":7,"./ifElseStatementFlip":8,"./ifStatement":9,"./ifStatementFlip":10,"./lib":12,"./runCode":13,"./usingAsk":14,"./validation":16}],12:[function(require,module,exports){
'use strict';
...
function onRunCodeEnd(runner) {
	if ($done === 3) return;

	var students = parseFloat(runner.input[0]);
	var books = parseFloat(runner.input[1]);
	...
	// show the message
	return this.assistant.say({ message: message, emote: emote });
}
...
(0, _waitForValidation2.default)(module.exports, {
	...
	validation: function validation(test, code) {
		...
		test.lines(2);
		(0, _validation.validate_ask)(test);
		test.lines(2);
		(0, _validation.validate_if)(test);
		test.lines(2);
		(0, _validation.validate_else_if)(test);
...
},{"./controllers/waitForValidation":4,"./lib":12,"./validation":16}],15:[function(require,module,exports){
'use strict';
...
exports.validate_else = exports.validate_else_if = exports.validate_if = exports.validate_variables = exports.validate_ask = undefined;

var _lodash = require('lodash');

var validate_ask = exports.validate_ask = function validate_ask(test) {

	test.declare('let')._s.id('totalStudents')._s.symbol('=')._s.id('console').symbol('.').func('ask').symbol('(').string('how many students?').symbol(')').symbol(';')._n.lines(2);

	test.declare('let')._s.id('totalBooks')._s.symbol('=')._s.id('console').symbol('.').func('ask').symbol('(').string('how many books?').symbol(')').symbol(';')._n;
};
...
var validate_variables = exports.validate_variables = function validate_variables(test) {
	...
	test.declare('let')._s.id('totalStudents')._s.symbol('=')._s.number(function (match, num) {
		if (!_lodash._.some(match) || num < 1 || num > 100) return 'Enter a number between 1 and 100';

		students = num;
	}).symbol(';')._n.lines(2);

	test.declare('let')._s.id('totalBooks')._s.symbol('=')._s.number(function (match, num) {
		if (!_lodash._.some(match) || num < 1 || num > 100) return 'Enter a number between 1 and 100';

		if (!!same) {
			if (num !== students) return 'Enter the same number as `totalStudents`';
		} else {
			if (num >= students && !flip) return 'Enter a number less than `totalStudents`';else if (num <= students && flip) return 'Enter a number greater than `totalStudents`';
		}
	}).symbol(';')._n;
};

var validate_if = exports.validate_if = function validate_if(test, options) {

	test.keyword('if')._s.symbol('(').id('totalStudents')._s.symbol('>')._s.id('totalBooks').symbol(')')._s.symbol('{')._n._t.id('console').symbol('.').func('log').symbol('(').string('not enough books').symbol(')').symbol(';')._n.symbol('}');
};

var validate_else_if = exports.validate_else_if = function validate_else_if(test, options) {

	test.keyword('else')._s.keyword('if')._s.symbol('(').id('totalStudents')._s.symbol('===')._s.id('totalBooks').symbol(')')._s.symbol('{')._n._t.id('console').symbol('.').func('log').symbol('(').string('exactly enough books').symbol(')').symbol(';')._n.symbol('}');
};

var validate_else = exports.validate_else = function validate_else(test, options) {

	test.keyword('else')._s.symbol('{')._n._t.id('console').symbol('.').func('log').symbol('(').string('there are enough books').symbol(')').symbol(';')._n.symbol('}');
};

},{"lodash":17}],17:[function(require,module,exports){
(function (global){
/**
 * @license
