...
// lesson controller
var codeClassesBasicLesson = function () {

	// setup the lesson
	function codeClassesBasicLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, codeClassesBasicLesson);
	...
	_createClass(codeClassesBasicLesson, [{
		key: 'activateSlide',
...
window.registerLesson('code_classes_basic', codeClassesBasicLesson);
