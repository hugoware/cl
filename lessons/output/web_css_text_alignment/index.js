...
// lesson controller
var webCssTextAlignmentLesson = function () {

	// setup the lesson
	function webCssTextAlignmentLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, webCssTextAlignmentLesson);
	...
	_createClass(webCssTextAlignmentLesson, [{
		key: 'activateSlide',
	...
	return webCssTextAlignmentLesson;
}();
...
window.registerLesson('web_css_text_alignment', webCssTextAlignmentLesson);
