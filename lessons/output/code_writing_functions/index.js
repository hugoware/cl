...
// lesson controller
var codeWritingFunctionsLesson = function () {

	// setup the lesson
	function codeWritingFunctionsLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, codeWritingFunctionsLesson);
	...
	_createClass(codeWritingFunctionsLesson, [{
		key: 'activateSlide',
	...
	return codeWritingFunctionsLesson;
}();
...
window.registerLesson('code_writing_functions', codeWritingFunctionsLesson);
