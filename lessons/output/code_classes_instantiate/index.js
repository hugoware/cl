...
// lesson controller
var codeClassesInstantiateLesson = function () {

	// setup the lesson
	function codeClassesInstantiateLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, codeClassesInstantiateLesson);
	...
	_createClass(codeClassesInstantiateLesson, [{
		key: 'activateSlide',
	...
	return codeClassesInstantiateLesson;
}();
...
window.registerLesson('code_classes_instantiate', codeClassesInstantiateLesson);
