...
// lesson controller
var codeElseIfLesson = function () {

	// setup the lesson
	function codeElseIfLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, codeElseIfLesson);
...
window.registerLesson('code_else_if', codeElseIfLesson);
