...
// lesson controller
var codeImportExportLesson = function () {

	// setup the lesson
	function codeImportExportLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, codeImportExportLesson);
	...
	_createClass(codeImportExportLesson, [{
		key: 'activateSlide',
...
window.registerLesson('code_import_export', codeImportExportLesson);
