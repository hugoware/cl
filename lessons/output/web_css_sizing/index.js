...
// lesson controller
var webCssSizingLesson = function () {

	// setup the lesson
	function webCssSizingLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, webCssSizingLesson);
	...
	_createClass(webCssSizingLesson, [{
		key: 'activateSlide',
...
window.registerLesson('web_css_sizing', webCssSizingLesson);
