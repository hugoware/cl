...
// lesson controller
var webAboutColorsLesson = function () {

	// setup the lesson
	function webAboutColorsLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, webAboutColorsLesson);
	...
	_createClass(webAboutColorsLesson, [{
		key: 'activateSlide',
...
window.registerLesson('web_about_colors', webAboutColorsLesson);
