...
// lesson controller
var webOrganizingProjectsLesson = function () {

	// setup the lesson
	function webOrganizingProjectsLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, webOrganizingProjectsLesson);
	...
	_createClass(webOrganizingProjectsLesson, [{
		key: 'activateSlide',
	...
	return webOrganizingProjectsLesson;
}();
...
window.registerLesson('web_organizing_projects', webOrganizingProjectsLesson);
