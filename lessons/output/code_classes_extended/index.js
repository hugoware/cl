...
// lesson controller
var codeClassesExtendedLesson = function () {

	// setup the lesson
	function codeClassesExtendedLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, codeClassesExtendedLesson);
	...
	_createClass(codeClassesExtendedLesson, [{
		key: 'activateSlide',
	...
	return codeClassesExtendedLesson;
}();
...
window.registerLesson('code_classes_extended', codeClassesExtendedLesson);
