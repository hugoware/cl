...
var exampleLesson = function () {

  // setup the lesson
  function exampleLesson(project, lesson, api, utils) {
    var _this = this;

    _classCallCheck(this, exampleLesson);
    ...
    this.data = {
      ...
      "lesson": [{
        ...
        "content": "Let's try some cool stuff\n"
      }, {
        "mode": "overlay",
        ...
        "mode": "overlay",
        "content": "It's exciting to start learning a new programming language, but before we learn how to start building web pages, it's a good idea to learn a bit about the technology that's running behind the scenes.\n"
      }, {
        "mode": "overlay",
        "content": "\nThere are three main technologies that are the backbone to creating the web pages that you see in the web browser.\n\n[image tech.png]\n\nThese are [define html], [define css], and [define javascript]. It's entirely possible that every single website you've ever visited was using all three of these languages.\n"
      }, {
        "mode": "overlay",
...
window.registerLesson('example', exampleLesson);
...
function onTryEditReadOnly(file) {}
