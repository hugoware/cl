...
// lesson controller
var webLayoutTwoColumnLesson = function () {

	// setup the lesson
	function webLayoutTwoColumnLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, webLayoutTwoColumnLesson);
	...
	_createClass(webLayoutTwoColumnLesson, [{
		key: 'activateSlide',
	...
	return webLayoutTwoColumnLesson;
}();
...
window.registerLesson('web_layout_two_column', webLayoutTwoColumnLesson);
