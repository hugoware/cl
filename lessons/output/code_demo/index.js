...
// lesson controller
var codeDemoLesson = function () {

  // setup the lesson
  function codeDemoLesson(project, lesson, api) {
    var _this = this;

    _classCallCheck(this, codeDemoLesson);
...
window.registerLesson('code_demo', codeDemoLesson);
