...
// lesson controller
var webCssFontBasicsLesson = function () {

	// setup the lesson
	function webCssFontBasicsLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, webCssFontBasicsLesson);
	...
	_createClass(webCssFontBasicsLesson, [{
		key: 'activateSlide',
...
window.registerLesson('web_css_font_basics', webCssFontBasicsLesson);
