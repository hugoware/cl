...
// lesson controller
var codeOperatorsLesson = function () {

	// setup the lesson
	function codeOperatorsLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, codeOperatorsLesson);
	...
	_createClass(codeOperatorsLesson, [{
		key: 'activateSlide',
...
window.registerLesson('code_operators', codeOperatorsLesson);
