...
// lesson controller
var codeOperatorsBasicLesson = function () {

	// setup the lesson
	function codeOperatorsBasicLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, codeOperatorsBasicLesson);
	...
	_createClass(codeOperatorsBasicLesson, [{
		key: 'activateSlide',
	...
	return codeOperatorsBasicLesson;
}();
...
window.registerLesson('code_operators_basic', codeOperatorsBasicLesson);
