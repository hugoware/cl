...
// lesson controller
var webCssPaddingMarginLesson = function () {

	// setup the lesson
	function webCssPaddingMarginLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, webCssPaddingMarginLesson);
	...
	_createClass(webCssPaddingMarginLesson, [{
		key: 'activateSlide',
	...
	return webCssPaddingMarginLesson;
}();
...
window.registerLesson('web_css_padding_margin', webCssPaddingMarginLesson);
