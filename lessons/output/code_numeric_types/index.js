...
// lesson controller
var codeNumericTypesLesson = function () {

	// setup the lesson
	function codeNumericTypesLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, codeNumericTypesLesson);
	...
	_createClass(codeNumericTypesLesson, [{
		key: 'activateSlide',
...
window.registerLesson('code_numeric_types', codeNumericTypesLesson);
