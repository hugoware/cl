...
// lesson controller
var codeMathBasicLesson = function () {

	// setup the lesson
	function codeMathBasicLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, codeMathBasicLesson);
	...
	_createClass(codeMathBasicLesson, [{
		key: 'activateSlide',
...
window.registerLesson('code_math_basic', codeMathBasicLesson);
