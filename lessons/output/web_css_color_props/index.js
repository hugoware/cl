...
// lesson controller
var webCssColorPropsLesson = function () {

	// setup the lesson
	function webCssColorPropsLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, webCssColorPropsLesson);
	...
	_createClass(webCssColorPropsLesson, [{
		key: 'activateSlide',
...
window.registerLesson('web_css_color_props', webCssColorPropsLesson);
