...
// lesson controller
var codeOperatorsSimpleLesson = function () {

	// setup the lesson
	function codeOperatorsSimpleLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, codeOperatorsSimpleLesson);
	...
	_createClass(codeOperatorsSimpleLesson, [{
		key: 'activateSlide',
	...
	return codeOperatorsSimpleLesson;
}();
...
window.registerLesson('code_operators_simple', codeOperatorsSimpleLesson);
