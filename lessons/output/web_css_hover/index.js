...
// lesson controller
var webCssHoverLesson = function () {

	// setup the lesson
	function webCssHoverLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, webCssHoverLesson);
	...
	_createClass(webCssHoverLesson, [{
		key: 'activateSlide',
...
window.registerLesson('web_css_hover', webCssHoverLesson);
