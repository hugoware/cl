...
// lesson controller
var webInputSelectLesson = function () {

	// setup the lesson
	function webInputSelectLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, webInputSelectLesson);
	...
	_createClass(webInputSelectLesson, [{
		key: 'activateSlide',
...
window.registerLesson('web_input_select', webInputSelectLesson);
