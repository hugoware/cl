...
// lesson controller
var codeFunctionReturnValueLesson = function () {

	// setup the lesson
	function codeFunctionReturnValueLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, codeFunctionReturnValueLesson);
	...
	_createClass(codeFunctionReturnValueLesson, [{
		key: 'activateSlide',
	...
	return codeFunctionReturnValueLesson;
}();
...
window.registerLesson('code_function_return_value', codeFunctionReturnValueLesson);
