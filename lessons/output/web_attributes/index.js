...
var _inputReadOnly = require('./inputReadOnly');

var inputReadOnly = _interopRequireWildcard(_inputReadOnly);
...
var _previewBlocked = require('./previewBlocked');

var previewBlocked = _interopRequireWildcard(_previewBlocked);

var _previewInput = require('./previewInput');

var previewInput = _interopRequireWildcard(_previewInput);
  ...
  function webAttributesLesson(project, lesson, api) {
    ...
    this.data = {
      ...
      "lesson": [{
        ...
        "content": "This is where you can use an [define html_attribute] to provide additional information so the `img` [define html_element Element] knows what to do.\n\n[snippet img_with_attr]\n\nLet's walk through each of the parts that make up an [define html_attribute].\n"
      }, {
        ...
        "content": "Let's try that again! Choose two more images that you'd like to add to the page. Use `img` [define html_element Elements] and the `src` [define html_attribute Attribute] like you did in the previous example.\n"
      }, {
        "content": "You can see that an [define html_attribute] allows us to provide additional instructions for [define html_element Elements] to change its behavior.\n"
      }, {
        "mode": "overlay",
        ...
        "mode": "overlay",
        "content": "Let's look at one more type of [define html_attribute Attribute] you will see from time to time.\n"
      }, {
        "content": "This is called a [define boolean_attribute]. Unlike the previous examples this [define html_attribute] does not have a value that's explicitly set.\n\n[snippet boolean_attribute_simple]\n"
      }, {
        "content": "For a [define boolean_attribute], simply having it added to an [define html_element Element] is enough for it to be treated as if it were _true_.\n\n[snippet boolean_attribute_simple]\n\nIn this example, the `button` [define html_element Element] is being set to a _\"disabled\"_ state, meaning it can't be pressed.\n"
      }, {
        ...
        "content": "The `input` [define html_element Element] has many [define html_attribute Attributes] that can dramatically change its behavior. By default though, an `input` [define html_element Element] will display as a simple text field.\n"
      }, {
        "controller": "previewInput",
        "content": "Click on the `input` [define html_element Element] in the [define preview_area] and then type in some letters.\n\nYou should be able to make changes to the text field without any issue.\n"
      }, {
        "content": "Now let's use an [define html_attribute] to prevent a user from making changes to this `input` [define html_element Element].\n"
      }, {
        "controller": "inputReadOnly",
        "content": "Follow along with the instructions to include a `readonly` [define html_attribute Attribute]. If you pay close attention you'll notice when the `input` [define html_element Element] becomes disabled.\n"
      }, {
        "controller": "previewBlocked",
        "content": "Now the `input` [define html_element Element] is disabled and won't allow users to make changes.\n\nClick on the `input` [define html_element Element] in the [define preview_area] and try to enter something into the text field.\n"
      }, {
        ...
        "content": "[snippet anchor_example highlight:5,14]\n",
        "explain": "An [define html_attribute] is an additional instruction that can be added to an [define html_element] to change its behavior. An [define html_attribute] is placed within and [define html_element Elements] opening tag.\n",
        ...
        "content": "[snippet anchor_example highlight:5,3]\n",
        ...
        "title": "What is the highlighted part of this [define html_attribute]?",
        "content": "[snippet anchor_example highlight:10,8]\n",
      ...
      "snippets": {
        "anchor_example": {
          "content": "<img src=\"/cat.png\" />",
          "type": "html"
        },
        "boolean_attribute_expanded": {
          "content": "<button disabled=\"disabled\" />",
          "type": "html"
        },
        "boolean_attribute_simple": {
    ...
    var refs = {
      inputEntry: inputEntry, inputReadOnly: inputReadOnly, multipleAttributes: multipleAttributes, multipleImages: multipleImages, previewBlocked: previewBlocked, previewInput: previewInput, srcExample: srcExample, validation: validation, waitForIndex: waitForIndex
    };
...
},{"./controllers/waitForFile":1,"./controllers/waitForObjectivesList":2,"./controllers/waitForTab":3,"./inputEntry":6,"./inputReadOnly":7,"./lib":8,"./multipleAttributes":9,"./multipleImages":10,"./previewBlocked":11,"./previewInput":12,"./srcExample":13,"./validation":14,"./waitForIndex":15}],6:[function(require,module,exports){
'use strict';
...
(0, _waitForValidation2.default)(module.exports, {
	...
	validation: function validation(test) {
		return test.merge(_validation.input_only).eof();
	},
...
},{"./controllers/waitForValidation":4,"./lib":8,"./validation":14}],7:[function(require,module,exports){
'use strict';
...
(0, _waitForValidation2.default)(module.exports, {
	...
	validation: function validation(test) {
		return test.merge(_validation.input_readonly).eof();
	},
...
},{"./controllers/waitForValidation":4,"./lib":8,"./validation":14}],8:[function(require,module,exports){
'use strict';
...
},{"./controllers/waitForValidation":4,"./lib":8,"./validation":14}],10:[function(require,module,exports){
'use strict';
...
},{"./controllers/waitForValidation":4,"./lib":8,"./validation":14}],11:[function(require,module,exports){
'use strict';
...
function onEnter() {
	...
	// wait for entry
	this.preview.addEvent('keyup', 'input', function (input) {
		$count++;
		if ($count < 3) return;

		// stop the event
		_this.preview.clearEvents();
...
function onEnter() {
	...
	// wait for entry
	this.preview.addEvent('keyup', 'input', function (input) {
		if (_lodash._.trim(input.target.value).length < 4) return;
...
},{"./controllers/waitForValidation":4,"./lib":8,"./validation":14}],14:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
	value: true
});
exports.input_readonly = exports.input_only = exports.multiple_images_with_sizes = exports.multiple_images = exports.first_src = undefined;

var _lib = require('./lib');

var first_src = exports.first_src = function first_src(test) {
	return test.__w$.open('img')._s.attrs([['src', '/cat.png']])._s$.close('/>')._n.__w$;
};
...
var multiple_images = exports.multiple_images = function multiple_images(test) {
	...
	for (var i = 0; i < 2; i++) {
		test.open('img')._s.attrs([['src'].concat(allowed, [validate])])._s$.close('/>')._n.__w$;
	}
};
...
var multiple_images_with_sizes = exports.multiple_images_with_sizes = function multiple_images_with_sizes(test) {
	...
	// dont' get too big
	var validateNumberSize = function validateNumberSize(num) {
		var value = 0 | num;
		if (isNaN(value) || value < 100 || value > 200) return 'Expected a number between 100 and 200';
	};
	...
	// only allow two matches
	for (var i = 0; i < 3; i++) {
		test.open('img')._s.attrs([['height', /^[0-9]{3}/, 'Expected number between 100 and 200', validateNumberSize], ['width', /^[0-9]{3}/, 'Expected number between 100 and 200', validateNumberSize], ['src', allowed, function (value) {
			var index = _lib._.indexOf(allowed, value);
			allowed.splice(index, 1);
		}]])._s$.close('/>')._n.__w$;
	}
};

var input_only = exports.input_only = function input_only(test) {
	return test.merge(multiple_images_with_sizes).open('input')._s.close('/>').__w$;
};

var input_readonly = exports.input_readonly = function input_readonly(test) {
...
},{"./controllers/waitForFile":1}],16:[function(require,module,exports){
(function (global){
/**
 * @license
