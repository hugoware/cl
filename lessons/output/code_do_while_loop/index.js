...
// lesson controller
var codeDoWhileLoopLesson = function () {

	// setup the lesson
	function codeDoWhileLoopLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, codeDoWhileLoopLesson);
	...
	_createClass(codeDoWhileLoopLesson, [{
		key: 'activateSlide',
...
window.registerLesson('code_do_while_loop', codeDoWhileLoopLesson);
