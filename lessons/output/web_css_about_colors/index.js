...
// lesson controller
var webCssAboutColorsLesson = function () {

	// setup the lesson
	function webCssAboutColorsLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, webCssAboutColorsLesson);
	...
	_createClass(webCssAboutColorsLesson, [{
		key: 'activateSlide',
	...
	return webCssAboutColorsLesson;
}();
...
window.registerLesson('web_css_about_colors', webCssAboutColorsLesson);
