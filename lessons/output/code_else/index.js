...
// lesson controller
var codeElseLesson = function () {

	// setup the lesson
	function codeElseLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, codeElseLesson);
...
window.registerLesson('code_else', codeElseLesson);
