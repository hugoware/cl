...
// lesson controller
var webLayoutThreeColumnLesson = function () {

	// setup the lesson
	function webLayoutThreeColumnLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, webLayoutThreeColumnLesson);
	...
	_createClass(webLayoutThreeColumnLesson, [{
		key: 'activateSlide',
	...
	return webLayoutThreeColumnLesson;
}();
...
window.registerLesson('web_layout_three_column', webLayoutThreeColumnLesson);
