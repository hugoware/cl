...
// lesson controller
var webFormsLesson = function () {

	// setup the lesson
	function webFormsLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, webFormsLesson);
...
window.registerLesson('web_forms', webFormsLesson);
