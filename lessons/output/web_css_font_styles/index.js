...
// lesson controller
var webCssFontStylesLesson = function () {

	// setup the lesson
	function webCssFontStylesLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, webCssFontStylesLesson);
	...
	_createClass(webCssFontStylesLesson, [{
		key: 'activateSlide',
...
window.registerLesson('web_css_font_styles', webCssFontStylesLesson);
