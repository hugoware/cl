...
// lesson controller
var webInputTextLesson = function () {

	// setup the lesson
	function webInputTextLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, webInputTextLesson);
	...
	_createClass(webInputTextLesson, [{
		key: 'activateSlide',
...
window.registerLesson('web_input_text', webInputTextLesson);
