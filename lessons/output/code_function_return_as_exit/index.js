...
// lesson controller
var codeFunctionReturnAsExitLesson = function () {

	// setup the lesson
	function codeFunctionReturnAsExitLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, codeFunctionReturnAsExitLesson);
	...
	_createClass(codeFunctionReturnAsExitLesson, [{
		key: 'activateSlide',
	...
	return codeFunctionReturnAsExitLesson;
}();
...
window.registerLesson('code_function_return_as_exit', codeFunctionReturnAsExitLesson);
