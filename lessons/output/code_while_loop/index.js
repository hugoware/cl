...
// lesson controller
var codeWhileLoopLesson = function () {

	// setup the lesson
	function codeWhileLoopLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, codeWhileLoopLesson);
	...
	_createClass(codeWhileLoopLesson, [{
		key: 'activateSlide',
...
window.registerLesson('code_while_loop', codeWhileLoopLesson);
