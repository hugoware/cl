...
// lesson controller
var codeFunctionArgumentsLesson = function () {

	// setup the lesson
	function codeFunctionArgumentsLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, codeFunctionArgumentsLesson);
	...
	_createClass(codeFunctionArgumentsLesson, [{
		key: 'activateSlide',
	...
	return codeFunctionArgumentsLesson;
}();
...
window.registerLesson('code_function_arguments', codeFunctionArgumentsLesson);
