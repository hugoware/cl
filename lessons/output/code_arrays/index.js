...
// lesson controller
var codeArraysLesson = function () {

	// setup the lesson
	function codeArraysLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, codeArraysLesson);
