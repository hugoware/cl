...
// lesson controller
var codeForLoopReverseLesson = function () {

	// setup the lesson
	function codeForLoopReverseLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, codeForLoopReverseLesson);
	...
	_createClass(codeForLoopReverseLesson, [{
		key: 'activateSlide',
	...
	return codeForLoopReverseLesson;
}();
...
window.registerLesson('code_for_loop_reverse', codeForLoopReverseLesson);
