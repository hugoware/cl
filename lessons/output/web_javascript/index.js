...
// lesson controller
var webJavascriptLesson = function () {

	// setup the lesson
	function webJavascriptLesson(project, lesson, api) {
		var _this = this;

		_classCallCheck(this, webJavascriptLesson);
	...
	_createClass(webJavascriptLesson, [{
		key: 'activateSlide',
...
window.registerLesson('web_javascript', webJavascriptLesson);
